export const projectList = [
  ...
  // },
  {
    ...
    decs: '온라인 비상주 사무실 서비스',
      ...
      '자동으로 데이터를 페칭하고 캐시하여 불필요한 네트워크 요청을 줄이고, 성능과 속도를 개선하기 위해 TanStack Query를 도입',
      '내장된 유효성 검사 기능과 커스텀 유효성 검사 추가, 최소한의 리렌더링을 통한 성능 최적화를 위해 react-hook-form을 도입',
    ],
    skillStacks: [
      'TypeScript',
      'Tailwind',
  ...
  },
  {
    ...
    decs: 'SNS 마케팅 서비스',
      ...
      '전역 상태 관리와 간단한 상태 관리를 위해 Context API 도입',
